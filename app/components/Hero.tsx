  ...
  return (
    <Container className="pt-20 pb-32 text-center lg:pt-32">
      <h1 className="max-w-4xl mx-auto text-5xl font-medium tracking-tight font-display text-slate-900 sm:text-6xl">
        WriteAuto writes a new article draft for you
        <span className="relative text-blue-600 whitespace-nowrap">
          ...
          <span className="relative">automatically every day at 8 AM PST.</span>
        </span>{" "}
      </h1>
      <p className="max-w-2xl mx-auto mt-6 text-lg tracking-tight text-slate-700">
        WriteAuto is a Headless CMS that writes one draft of an article a day
        for you.
      </p>
